...
class FreepCrawler():
    ...
    def crawlURLs(self):
        page_count = 0
        #will scrape 40 page requests worth of articles that takes you roughly down to November,2018 depending on what youre scraping
        while page_count < 40:
            try:
                for url in self.baseURLs:
                    url = str(url) + "?page=%d" % page_count
